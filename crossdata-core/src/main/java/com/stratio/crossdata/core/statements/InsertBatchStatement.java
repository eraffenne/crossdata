...
/** Class that models a batch statement.
 */
public class InsertBatchStatement extends StorageStatement {
    ...
    private scala.collection.immutable.List<String> columns = null;

    private scala.collection.immutable.List<scala.collection.immutable.List<String>> rawRows = null;
   ...
   /* *//**
    ...
    public scala.collection.immutable.List<String> getStringColumns() {
        return columns;
    }

    public void setColumnsName(scala.collection.immutable.List<String> cols) {
        columns = cols;
    }

    public scala.collection.immutable.List<scala.collection.immutable.List<String>> getRawRows() {
        return rawRows;
    }

    public void setRawRows(scala.collection.immutable.List<scala.collection.immutable.List<String>> rawRows) {
